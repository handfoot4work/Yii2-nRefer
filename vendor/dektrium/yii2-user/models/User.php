...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function scenarios()
    {
        ...
        return ArrayHelper::merge($scenarios, [
            'register' => ['username', 'email', 'password','prename','fname','lname','hocde','position','position_level','tel_office','tel_mobile','remark'],
            'connect'  => ['username', 'email','prename','fname','lname','position','position_level','hocde','tel_office','tel_mobile','remark'],
            'create'   => ['username', 'email', 'password','prename','fname','lname','position','position_level','hocde','tel_office','tel_mobile','remark'],
            'update'   => ['username', 'email', 'password','prename','fname','lname','position','position_level','hocde','tel_office','tel_mobile','remark'],
            'settings' => ['username', 'email', 'password','prename','fname','lname','position','position_level','hocde','tel_office','tel_mobile','remark'],
        ]);
    }
    ...
    public function rules()
    {
        return [
            // username rules
            'nameLength'   => [['prename','fname','lname','position'], 'string', 'min' => 3, 'max' => 50],
            'nameRequired' => [['prename','fname','lname','position','hcode'], 'required'],
            'hcodeLength'   => [['hcode'], 'string', 'min' => 5, 'max' => 50],
            'nameTrim'     => [['prename','fname','lname','position','hcode'], 'filter', 'filter' => 'trim'],
