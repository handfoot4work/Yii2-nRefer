...
echo GridView::widget([
    ...
    'panel' => [
        'heading'=>'<h2 class="panel-title"><a href="'.Url::to(['/refer/report/sum_hcode','region'=>$region,'changwat'=>$changwat,'date'=>$date]).'"><i class="glyphicon glyphicon-circle-arrow-left"></i></a> ข้อมูลจากตาราง '.$tablename.' </h2>',
...
/*        [
        ...
        [
            'label'=>'Disease',
            'value'=>'PTYPEDISC',
        //    'value'=> function($data) use ($PTypeDisease) { return $PTypeDisease[$data['PTYPEDISC']] ;},
            'headerOptions' => ['style'=>'text-align:center'],
...
// Referid_Province	 Referid_Origin	Hospcode Origin	Datetime Serv	Datetime Admit	Datetime Refer	Clinic Refer		Chiefcomp	Physicalexam	Diagfirst	Diaglast	Pstatus	Ptype	Emergency	Ptypedis	Causeout	Request	Provider	D Update	Makedatetime	Recordstatus
